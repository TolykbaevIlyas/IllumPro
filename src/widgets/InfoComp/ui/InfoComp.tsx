...
const InfoComp = () => {
  return (
    <ul className="flex max-[1280px]:flex-col w-full  min-[1280px]items-center gap-[15px] mt-[40] max-[1270px]:px-[24px] max-[1281px]:px-[66px] min-[1280px]:mt-[91px] max-w-[1351px] max-[1920px]:h-[93px] min-[1920]:h-[124px] text-[#2E2C30]">
